...
export const AnimatedTestimonials = ({
 ...
 // Use the testimonials prop passed to the component
  ...
  const randomRotateY = () => {
    ...
    return (
        <div className="min-h-screen bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(to_right,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:44px_44px] relative">
